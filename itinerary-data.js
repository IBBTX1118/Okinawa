    ...
    },
    {
      ...
      waypoints: [
        ...
        },
        {
          ...
          tags: ["夜間返程", "西海岸快速道路", "戰利品清點", "周邊平價停車"],
          desc: "從 PARCO CITY 沿西海岸快速道路直通飯店（車程僅 15~18 分鐘）。跑車建議直接停放飯店旁步行 2 分鐘的高 CP 值露天平面停車場，省去立體機械車位等候時間且更護車！",
    ...
    },
    {
      ...
      waypoints: [
        ...
        },
        {
          ...
          color: "#6366f1",
          icon: "🏨",
          parkingInfo: "高CP推薦：步行2分「ザ・パーク西町第3 (夜間最大¥400)」或「タイムズ西1丁目 (夜間¥500)」",
          tags: ["返回飯店", "周邊平價停車", "整理行李", "打包戰利品"],
          desc: "結束南部巡禮與國際通熱鬧夜生活，回到 Nest Hotel 整理行李。若今晚仍有租車自駕，推薦停放步行 2 分鐘的「ザ・パーク西町第3 (夜間¥400)」或「タイムズ西1丁目 (夜間¥500)」，省錢省時！",
          tips: "明天為沖繩行程最後一天，今晚先將戰利品裝箱秤重，確認護照與機票預辦登機資訊。"
        }
      ]
    },
    {
